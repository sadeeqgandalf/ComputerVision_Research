...
except ImportError:  # Apple Silicon / non-CUDA environments
    triton = None
    tl = None
...
def _edt_cv2(data: torch.Tensor) -> torch.Tensor:
    """CPU/MPS fallback matching cv2.distanceTransform(..., DIST_L2, 0)."""
    import cv2
    import numpy as np
...
if _TRITON_AVAILABLE:
    ...
    def edt_kernel(
        ...
        for q in range(1, length):
            ...
            if k + 1 < length:
                # The right-most parabola covers the rest of the space (until we find a new one)
