...
import torch
from sam3.model.device_utils import amp_context, feature_storage_dtype, to_compute_device
...
class Sam3TrackerPredictor(Sam3TrackerBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bf16_context = amp_context(dtype=torch.bfloat16)
    ...
    def init_state(
        ...
        from sam3.model.device_utils import get_torch_device
        ...
        if offload_state_to_cpu or not torch.cuda.is_available():
            ...
            inference_state["storage_device"] = get_torch_device()
    ...
    def add_new_points_or_box(
        ...
        if self.iter_use_prev_mask_pred:
            ...
            if prev_out is not None and prev_out["pred_masks"] is not None:
                prev_sam_mask_logits = to_compute_device(
                    prev_out["pred_masks"], non_blocking=True
                )
    ...
    def _get_image_feature(self, inference_state, frame_idx, batch_size):
        ...
        if backbone_out is None:
            if self.backbone is None:
                ...
                image = (
                    to_compute_device(inference_state["images"][frame_idx])
                    .float()
                    .unsqueeze(0)
                )
    ...
    def _run_single_frame_inference(
        ...
        maskmem_features = current_out["maskmem_features"]
        if maskmem_features is not None:
            maskmem_features = maskmem_features.to(feature_storage_dtype())
