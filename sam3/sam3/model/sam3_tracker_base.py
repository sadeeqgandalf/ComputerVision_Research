    ...
    def _prepare_memory_conditioned_features(
        ...
        if not is_init_cond_frame and use_prev_mem_frame:
            ...
            for t_pos, prev, is_selected_cond_frame in t_pos_and_prevs:
                ...
                # so we load it back to the compute device (no-op if already there).
                feats = to_compute_device(prev["maskmem_features"], non_blocking=True)
                ...
                maskmem_enc = to_compute_device(prev["maskmem_pos_enc"][-1])
